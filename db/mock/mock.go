...
// Source: gohub/db (interfaces: Interface)
...
func (m *MockInterface) Do(arg0 context.Context, arg1 string, arg2 map[string]interface{}) *graphql.Result {
...
func (m *MockInterface) Init(arg0 graphql.Schema, arg1 *viper.Viper) error {
